...
import 'package:tri_express/features/inventory/domain/use_cases/fetch_delivery_goods_use_case.dart';
...
void main() {
  ...
  group(
    'fetch delivery goods',
    () {
      const params =
          FetchDeliveryGoodsUseCaseParams(currentPage: 1, perPage: 10);
      test(
        'should return List<BatchEntity> when the request status code is 200',
        () async {
          // arrange
          final jsonString =
              fixtureReader('data_sources/get_delivery_goods.json');
          ...
          // act
          final result = await inventoryRemoteDataSources.fetchDeliveryGoods(
              params: params);
